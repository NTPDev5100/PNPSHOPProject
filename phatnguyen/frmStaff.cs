...
namespace phatnguyen
{
    public partial class frmStaff : Form
    {
        ...
        {
            cbxSearchStaff.Items.Add("Staff Code");
            cbxSearchStaff.Items.Add("Staff Name");
            cbxSearchStaff.Items.Add("Staff DOB");
            cbxSearchStaff.Items.Add("Staff Address");
            cbxSearchStaff.Items.Add("Staff Gender");
        }
